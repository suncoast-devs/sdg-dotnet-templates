...
3. run `nuget pack .`
4. run `nuget push SDG.templates.Console.Database.X.X.X.nupkg -Source https://www.nuget.org` with the correct version number
...
```sh
dotnet new --install SDG.templates.Console.Database::X.X.X
```
